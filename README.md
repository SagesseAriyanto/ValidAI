...
ValidAI is an intelligent dashboard designed to validate startup ideas. It uses machine learning to predict market fit and success, offers a chat assistant for insights, and provides full access to explore and filter the entire dataset of AI tools.

🔗 **Live Demo:** [https://validai.streamlit.app/](https://validai.streamlit.app/)
...
**Built With:** Python • Streamlit • Scikit-learn • Pandas • Plotly • Google Gemini API

## 📊 Data Source

The dataset used in this project was generated using a custom web scraper. You can view the source code here:
👉 **[AI Companies Scraper](https://github.com/SagesseAriyanto/AI-Companies-Scraper)**